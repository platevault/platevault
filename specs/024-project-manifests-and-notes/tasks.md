...
- **workflow_run subscriber startup spawn**: DONE — `spawn_workflow_run_subscriber` is wired at app startup in `apps/desktop/src-tauri/src/lib.rs` (~line 705). (Stale deferral corrected 2026-06-23 during close-out.)
