...
| 044 targets-planner-astronomy | ⚪ Spec drafted (Track A) | Split 2026-07-04: **Track A** (moon phase/illumination/separation + filter guidance + opposition, date+RA/Dec only — spec.md authored, awaiting clarify answers before plan/tasks) vs **Track B** (observer-location ephemeris: altitude/rise/set/transit — separate research-gated effort). Frontend still mocked; former blocker #57 (list-endpoint RA/Dec enrichment) resolved |
