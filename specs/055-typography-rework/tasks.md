...
- [x] T031 ~~One-line clarification into spec 054~~ DROPPED 2026-07-17: spec 054
      (adaptive detail dock) is a separate feature that has since shipped on its
      own track; it addresses list-page detail-panel placement, not this
      shell/zoom viewport degradation, so no cross-edit was made. Phase 4 ships
      at 150% with the FR-006 degradation envelope documented in this spec.
