...
- **Foundational**: migration `0048_inbox_single_type.sql` (`inbox_source_groups`, sub-item identity `(root_id, relative_path, group_key)`, `inbox_file_overrides`, collapsed classification result, extended metadata incl. pixel size) — T061; extended FITS/XISF extraction — T062. (FR-034/FR-042/FR-046/FR-053/FR-054)
