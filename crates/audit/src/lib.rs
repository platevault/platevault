...
pub use event_bus::{
    ...
    SettingsSnapshot, Source, SourceCountByKind, TargetResolveBatchCompleted, TargetResolved,
    ...
    TOPIC_SETTINGS_SNAPSHOT, TOPIC_TARGET_RESOLVED, TOPIC_TARGET_RESOLVE_BATCH_COMPLETED,
};
