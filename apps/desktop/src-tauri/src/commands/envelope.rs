//! Generic envelope command adapter.
//!
//! Carried forward from the pre-Tauri stub: lets the contract test suite
//! exercise `RequestEnvelope` / `ResponseEnvelope` shapes without owning a
//! live Tauri runtime. New typed commands should land in [`super::lifecycle`].
