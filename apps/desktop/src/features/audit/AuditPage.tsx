  ...
  if (loading) {
    return (
      <div className="alm-page" data-testid="AuditPage">
        <div className="alm-page__loading">Loading audit log...</div>
      </div>
    );
  }
        ...
        content={
          selectedEntry ? (
            ...
            <EmptyState
              ...
              description="Select an audit event from the list to view its full detail."
            />
          )
        }
        detail={
          selectedEntry ? (
            <AuditContext entry={selectedEntry} allEntries={entries} />
          ) : (
            <div className="alm-inspector">
              <div className="alm-inspector__empty">
                Select an event to view related context
              </div>
            </div>
          )
        }
