...
export interface StepInboxProps {
  entries: SourceEntry[];
...
const EXAMPLE_PATHS = [
  '/astro/inbox',
  'D:\\Astrophotography\\Incoming',
  '/Volumes/AstroData/Watch',
];

/**
 * Step — Inbox sources (optional).
 * Watched folders for newly captured data.
 */
export function StepInbox({ entries, onAdd, onRemove, onScanDepthChange, errors }: StepInboxProps) {
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--alm-space-5)' }}>
      <Box>
        ...
        >
          Watched folders for newly captured data. Optional — useful for automated
          import of new captures.
        </p>
