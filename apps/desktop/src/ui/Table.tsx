            ...
            <>
              {paddingBefore > 0 && (
                <tr aria-hidden="true" className="alm-table__spacer">
                  {/* eslint-disable no-restricted-syntax, jsx-a11y/control-has-associated-label -- dynamic: virtualizer before-spacer height; decorative spacer in aria-hidden row, no label needed */}
                  <td
                    colSpan={colCount}
              ...
              {paddingAfter > 0 && (
                <tr aria-hidden="true" className="alm-table__spacer">
                  {/* eslint-disable no-restricted-syntax, jsx-a11y/control-has-associated-label -- dynamic: virtualizer after-spacer height; decorative spacer in aria-hidden row, no label needed */}
                  <td
                    colSpan={colCount}
