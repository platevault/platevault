...
export const CLEANUP_TYPES: CleanupTypeFixture[] = [
  ...
  // Processing intermediates — regenerable by re-running the pipeline.
  {
    ...
    action: 'Delete',
    stage: 'Processing intermediates',
  },
  {
    id: 9,
  ...
  {
    id: 14,
    type: 'Stack output (intermediate)',
    action: 'Archive',
    stage: 'Processing intermediates',
  },
  {
  ...
  {
    id: 17,
    type: 'Processing logs',
    action: 'Archive',
    stage: 'Project metadata',
  },
  {
    id: 18,
    type: 'Process icons / tool config',
    action: 'Keep',
    stage: 'Project metadata',
  },
